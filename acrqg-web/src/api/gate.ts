...
import type { GateResultDTO, QualityGateDTO, QualityGateSaveRequest } from '@/types/api'
...
export function save(projectId: number, req: QualityGateSaveRequest): Promise<QualityGateDTO> {
